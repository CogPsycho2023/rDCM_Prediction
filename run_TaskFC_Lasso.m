function [Correlation, MAE, sum_mask_all] = run_taskFC_Lasso(all_behav, all_mats,k, thresh_type,thresh,lambda)
...
for fold = 1:k
    ...
    mdl_combined = fitrlinear(x_combined, train_behav,'Regularization','lasso','Lambda',lambda);
