    ...
    for Network = 1:7;
        ...
        for run = 1: NUM_RUNS
            ...
            for lambda = lambda_values
                ...
                [Correlation, MAE, sum_mask_all] = run_EC_Ridge(all_behav, all_mats, k, thresh_type, thresh, lambda);
        ...
        outname = string(strcat('EC_network',num2str(Network),thresh_type,'_',num2str(thresh),'10fold_Ridge.mat'));
